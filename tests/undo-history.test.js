...
test('subtitle history keeps only five undo operations and supports redo', () => {
  const history = createUndoHistory(5);
  for (let value = 0; value < 7; value++) history.checkpoint({ value });

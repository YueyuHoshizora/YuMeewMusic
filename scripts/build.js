...
for (const path of ["index.html", "account.html", "settings.html", "subtitle-editor.html", "converter.html", "video-editor.html", "image-video.html", "vocal-separator.html", "music-rating.html", "suno-tool.html", "image-generator.html", "video-generator.html", "video-generator.webmanifest", "favicon.svg", "ads.txt", "service-worker.js", "CNAME", "icons", "css", "js", "vendor"])
  await cp(path, `dist/${path}`, { recursive: true });
// A single content-derived version keeps entry points and app modules in sync after deploys.
const htmlFiles = ["index.html", "account.html", "settings.html", "subtitle-editor.html", "converter.html", "video-editor.html", "image-video.html", "vocal-separator.html", "music-rating.html", "suno-tool.html", "image-generator.html", "video-generator.html"];
const files = [...htmlFiles, "video-generator.webmanifest", "ads.txt", "service-worker.js", "css/style.css", "css/account.css", "css/settings.css", "css/subtitle-editor.css", "css/converter.css", "css/video-editor.css", "css/image-video.css", "css/vocal-separator.css", "css/music-rating.css", "css/suno-tool.css", "css/image-generator.css", "css/video-generator.css", "vendor/supabase.min.mjs", ...(await readdir("js")).filter(name => name.endsWith(".js")).sort().map(name => `js/${name}`)];

...
test("video generator page provides a model-ready generation workspace", () => {
  ...
  assert.match(script, /const STORYBOARD_PRIMARY_URL = "https:\/\/storyboard-checker\.the-music\.app\/api\/storyboard\/check"/);
  assert.match(script, /const STORYBOARD_FALLBACK_URL = "https:\/\/inspiration-chat\.the-music\.app\/api\/storyboard\/check"/);
  ...
  assert.match(script, /https:\/\/model-proxy\.the-music\.app\/minimax\/video/);
  ...
  assert.match(script, /https:\/\/model-proxy\.the-music\.app\/byteplus\/video/);
  ...
  assert.match(script, /GOOGLE_VIDEO_PROXY_URL = "https:\/\/model-proxy\.the-music\.app\/google\/video"/);
  ...
  assert.match(script, /RESOURCE_UPLOAD_URL = "https:\/\/model-proxy\.the-music\.app\/resources\/upload"/);

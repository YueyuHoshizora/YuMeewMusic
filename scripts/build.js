...
const files = [...htmlFiles, "css/style.css", "css/subtitle-editor.css", "css/converter.css", "css/video-editor.css", "css/image-video.css", "css/vocal-separator.css", "css/text-to-image.css", ...(await readdir("js")).filter(name => name.endsWith(".js")).sort().map(name => `js/${name}`)];

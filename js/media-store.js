...
const ALLOWED_VALUE_KINDS = new Set(["image-video-project", "image-generation-history", "video-character-templates", "video-generator-draft", "video-generator-draft-resources", "video-generation-task", "video-generation-history", "mv-character-templates", "mv-generator-draft", "mv-generation-history"]);
const ENTRY_DETAILS = Object.freeze({
  ...
  "mv-character-templates": { page: "動畫生成", field: "人物模板" },
  "mv-generator-draft": { page: "動畫生成", field: "自動儲存草稿" },
  "mv-generation-history": { page: "動畫生成", field: "生成歷史" },
});

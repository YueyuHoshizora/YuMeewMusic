...
test("video generator page provides a model-ready generation workspace", () => {
  ...
  assert.match(script, /const STORYBOARD_PRIMARY_URL = "https:\/\/storyboard-checker\.yustellar\.idv\.tw\/api\/storyboard\/check"/);
  assert.match(script, /const STORYBOARD_FALLBACK_URL = "https:\/\/inspiration-chat\.yustellar\.idv\.tw\/api\/storyboard\/check"/);
